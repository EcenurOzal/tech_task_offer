...
part of 'sponsored_offers.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SponsoredOffers _$SponsoredOffersFromJson(Map<String, dynamic> json) =>
    SponsoredOffers(
      ...
      sponsoredRate: json['sponsored_rate'] as num?,
    );

Map<String, dynamic> _$SponsoredOffersToJson(SponsoredOffers instance) =>
    <String, dynamic>{
