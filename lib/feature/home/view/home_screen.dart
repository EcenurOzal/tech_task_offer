...
import 'package:tech_task_offer/feature/home/mixin/home_screen_mixin.dart';
...
class _HomeViewState extends State<HomeView> with HomeScreenMixin {
  @override
  Widget build(BuildContext context) {
              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: context.xMaterialColorTheme.onSurface.withOpacity(0.2),
                    ),
                  ),
                  child: Padding(
                ...
                child: Column(
                  children: [
                    if (state.activeOffers?.isNotEmpty ?? false) ...[
                      ListView.separated(
                        separatorBuilder: (context, index) => AppPadding.xVertical28(),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          //? Taksit Listesi
                          List<DetailedLoanInstallment> installmentList = createInstallmentList(
                            state.selectedLoan!.defaultAmount.toDouble(),
                            state.activeOffers![index].interestRate ?? 0.0,
                            state.selectedLoan!.defaultMaturity,
                          );
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      TitleCard(
                                          title: "Faiz Oranı",
                                          subTitle: state.activeOffers![index].interestRate!.toString()),
                                      TitleCard(
                                  ...
                                  InkWell(
                                    onTap: () {
                                      showLoanPopUp(context, installmentList, state.activeOffers![index],
                                          state.selectedLoan!, mountlyPayment);
                                    },
                                    child: Container(
                                        width: double.infinity,
                                        decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(8),
                                          color: context.xMaterialColorTheme.primary.withOpacity(0.8),
                                        ),
                                        child: Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Center(
  ...
  Future<dynamic> showLoanPopUp(BuildContext context, List<DetailedLoanInstallment> installmentList, OffersModel model,
      LoanModel selectedLoan, double mountlyPayment) {
    return showDialog(
      context: context,
          ...
          child: SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  //
                  AppText.bodyLarge(context, model.bank ?? "", color: context.xMaterialColorTheme.primary),
                  ...
                  Center(
                    child: Wrap(
                      ...
                      children: [
                        ...
                        TitleCard(
                          title: "Yıllık Oran",
                          subTitle: "₺${model.annualRate?.toStringAsFixed(2)}",
                        ),
                        AppPadding.xVertical8(),
                        TitleCard(
                            title: "Toplam Tutar",
                        ...
                        AppPadding.xVertical8(),
                        TitleCard(title: "Masraf", subTitle: "₺${AppConst.masraf}"),
                      ],
                    ),
                  ),
  ...
  DataTable _buildDataTable(List<DetailedLoanInstallment> installmentList) {
    return DataTable(
      ...
      rows: List.generate(installmentList.length, (index) {
        ...
        return DataRow(
          cells: [
            DataCell(AppText.bodyMedium(context, '${installment.installmentNumber}')),
            DataCell(AppText.bodyMedium(context, '₺${installment.principalAmount.toStringAsFixed(2)}')),
            DataCell(AppText.bodyMedium(context, '₺${installment.interestAmount.toStringAsFixed(2)}')),
            DataCell(AppText.bodyMedium(context, '₺${installment.kkdf.toStringAsFixed(2)}')),
            DataCell(AppText.bodyMedium(context, '₺${installment.bsmv.toStringAsFixed(2)}')),
            DataCell(AppText.bodyMedium(context, '₺${installment.remainingPrincipal.toStringAsFixed(2)}')),
          ],
        );
      }),
    );
              ...
              children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      CustomRadioButton(
                        ...
                        isSelected: state.selectedLoan!.carType == CarType.newCar,
                        onTap: () {
                      ...
                      CustomRadioButton(
                        ...
                        isSelected: state.selectedLoan!.carType == CarType.secondHandCar,
                        onTap: () {
                          context.read<HomeCubit>().setCarType(CarType.secondHandCar);
                        },
                      ),
                    ],
                  ),
                ...
                Padding(
                  ...
                  child: CustomSlider(
                    ...
                    onChanged: (double value) {
                      int roundedValue = (value / state.selectedLoan!.division).round() * state.selectedLoan!.division;
                ...
                Padding(
                  ...
                  child: CustomSlider(
                    ...
                    toggleColor: context.xMaterialColorTheme.primary,
                    defaultValue: state.selectedLoan!.defaultMaturity.toDouble(),
                    onChanged: (double value) {
                      context.read<HomeCubit>().setSliderMaturity(value.toInt());
                    },
                  ),
                ),
